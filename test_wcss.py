...
print('GPU Available', len(phisical_devices))
...
def tnet(inputs, num_features):
    bias = keras.initializers.Constant(np.eye(num_features).flatten())  # Change here: Use num_features for bias initialization
